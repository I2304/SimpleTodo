...
import static com.ikarmarkar.simpletodo.MainActivity.ITEM_POSITION;
import static com.ikarmarkar.simpletodo.MainActivity.ITEM_TEXT;

public class EditItemActivity extends AppCompatActivity {
    // text field that contains updated item description
    EditText etItemText;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // track position of the item in the list
